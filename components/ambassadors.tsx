...
export function Ambassadors() {
  const instructor = {
    ...
    img: "/placeholder.svg?height=900&width=700",
  }
  const students = [
    { name: "Nguyen Le Truong Thien", role: "Developer", img: "/placeholder.svg?height=900&width=700" },
    { name: "Phan Cong Hung", role: "Developer", img: "/placeholder.svg?height=900&width=700" },
    { name: "Truong Ngoc Huyen", role: "Developer", img: "/placeholder.svg?height=900&width=700" },
    { name: "Tran Pham Thanh Truc", role: "Developer", img: "/placeholder.svg?height=900&width=700" },
  ]
